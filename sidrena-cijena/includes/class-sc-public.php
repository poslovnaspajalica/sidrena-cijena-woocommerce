...
final class SC_Public {
	...
	public static function maybe_render(): void {
		...
		if ( $what === 'latest' ) {
			...
			wp_safe_redirect( SC_Export::files_url() . rawurlencode( $last[ $fmt ] ), 302 );
			exit;
		}
...
<p>
Sidrena cijena: cijena koja je vrijedila na dan <strong><?php echo esc_html( SC_Settings::format_date( $s['referentni_datum'] ) ); ?></strong>
		<?php
		if ( ! empty( $s['alt_kategorije'] ) ) :
			?>
	, odnosno <?php echo esc_html( SC_Settings::format_date( $s['alt_datum'] ) ); ?> za kategorije obuhvaćene Odlukom NN 75/2025.<?php endif; ?>
</p>
